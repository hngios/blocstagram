...
+ (void)load {
    ...
    usernameLabelGray = [UIColor colorWithRed:.933 green:.933 blue:.933 alpha:1];
    commentLabelGray = [UIColor colorWithRed:.898 green:.898 blue:.898 alpha:1];
    linkColor = [UIColor colorWithRed:.345 green:.345 blue:.345 alpha:1];
...
- (void) setMediaItem:(BLCMedia *)mediaItem {
    _mediaItem = mediaItem;  //causes infinite recursion
...
+ (CGFloat) heightForMediaItem:(BLCMedia *)mediaItem width:(CGFloat)width {
   ...
   BLCMediaTableViewCell *layoutCell = [[BLCMediaTableViewCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:@"layoutCell"];
    ...
    //set given width, and max possible height
    layoutCell.frame = CGRectMake(0, 0, width, CGFLOAT_MAX);
    
    //give it media item
    layoutCell.mediaItem = mediaItem;
    
    //make it adjust the image view andlabels
